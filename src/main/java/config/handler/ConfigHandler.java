...
public class ConfigHandler {
	...
	public final static String MYSQL_USERNAME9 = "admin";
	public final static String MYSQL_PASSWORD = "MySQL@seil";
	public final static String MYSQL_PASSWORD9 = "letmein";
	public final static String MYSQL_DATABASE_NAME = "seil_sensor_data";
	public final static String MYSQL_DATABASE_NAME9 = "app_portal";
	public final static String MYSQL_URL = "jdbc:mysql://" + MYSQL_HOST + ":3306/" + MYSQL_DATABASE_NAME + "?useSSL=false";
	public final static String MYSQL_URL9 = "jdbc:mysql://" + "10.129.149.9" + ":3306/" + MYSQL_DATABASE_NAME9 + "?useSSL=false";
